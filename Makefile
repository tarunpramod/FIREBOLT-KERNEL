...
PATCHLEVEL = 14
SUBLEVEL = 62
EXTRAVERSION =--FIREBOLT KERNEL 1.O By ATP
NAME = Petit Gorille
...
ARCH		?=arm64
CROSS_COMPILE	?=/home/atp/toolchain/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
CC		= /home/atp/toolchain/clang/host/linux-x86/clang-4639204/bin/clang
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE= /home/atp/toolchain/clang/host/linux-x86/clang-4639204/bin/aarch64-linux-gnu-
